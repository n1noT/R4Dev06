...
### 1_1 Ajout d'une props `className` :
...
### 1_2 Concaténation des classes Tailwind avec un template literal :
...
### 3_2 Méthode 2 : Class Variance Autority CVA
...
[Git Heroicons](https://github.com/tailwindlabs/heroicons)
